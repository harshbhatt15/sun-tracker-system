  ...
  head: () => ({
    meta: [
      { title: "System Health — SunTrack Pro" },
      {
        name: "description",
        content:
          "Health status of the ESP32 link, LDR sensors, tracker motors, panel and power sensor.",
      },
      { property: "og:title", content: "System Health — SunTrack Pro" },
      {
        property: "og:description",
        content: "Subsystem diagnostics for the solar tracking controller.",
      },
    ],
  }),
    ...
    <div className="space-y-4">
        ...
        <Button
          ...
          onClick={() =>
            executeProtectedAction(
              () => engine.injectSensorFault(),
              "Toggle Hardware Sensor Fault Simulation",
            )
          }
      ...
      <Panel title="Runtime telemetry">
        <div className="grid grid-cols-2 gap-2 lg:grid-cols-4">
          ...
          <Metric
            label="Firmware link"
            value={s.settings.simulationMode ? "SIMULATED" : s.settings.esp32Ip}
          />
