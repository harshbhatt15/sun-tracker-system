...
export const Route = createFileRoute("/tracking")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Animated live solar tracker visualization and telemetry." },
    ],
  }),
        ...
        <div className="space-y-4">
          <Panel title="Sun" icon={<Sun className="h-4 w-4" />}>
            <div className="grid grid-cols-2 gap-2">
              ...
              <Metric label="Elevation" value={Math.max(0, s.sun.elevation).toFixed(1)} unit="°" tone="solar" />
