  ...
  head: () => ({
    meta: [
      { title: "Energy Monitoring — SunTrack Pro" },
      {
        name: "description",
        content:
          "Voltage, current, power and energy yield charts for the SunTrack Pro solar tracking system.",
      },
      { property: "og:title", content: "Energy Monitoring — SunTrack Pro" },
      {
        property: "og:description",
        content: "Interactive power, energy and sunlight charts with time filters.",
      },
    ],
  }),
