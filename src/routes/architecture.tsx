  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Hardware Architecture — SunTrack Pro" },
      {
        ...
        content: "How the sensors, controller, motors and dashboard connect.",
      },
    ],
  }),
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Data path from the Sun to this dashboard — designed so the simulated layer can be swapped
          for a real ESP32 over REST, WebSocket or MQTT.
        </p>
      </div>
          ...
          <ol className="space-y-1">
            {blocks.map((b, i) => (
              <li key={b.title}>
                ...
                >
                  <div className="truncate font-display text-sm font-bold text-solar">
                    {b.title}
                  </div>
